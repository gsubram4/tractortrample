...
public class TrampleFenceFactory implements IntervalFactory {
	...
	public Interval createInterval(float xPos, float yPos, SlidingSpeed slidingSpeed) {
		...
		myEntities[0] = TrampleFence.Factory().setPosition(xPos + 0, yPos + 150).setSlidingSpeed(slidingSpeed);
		myEntities[1] = TrampleFence.Factory().setPosition(xPos + 50, yPos + 120).setSlidingSpeed(slidingSpeed);
		myEntities[2] = TrampleFence.Factory().setPosition(xPos + 100, yPos + 90).setSlidingSpeed(slidingSpeed);
		myEntities[3] = TrampleFence.Factory().setPosition(xPos + 150, yPos + 60).setSlidingSpeed(slidingSpeed);
		myEntities[4] = TrampleFence.Factory().setPosition(xPos + 200, yPos + 30).setSlidingSpeed(slidingSpeed);
